...
import { generateSectorPaths, generateSticks } from '../sectorGenerators';
import type { PrizeWheelProps, PrizeWheelRef } from '../../types';
import { useWheelAnimation } from '../../hooks/useWheelAnimation';
import './style.css';

const PrizeWheel = forwardRef<PrizeWheelRef, PrizeWheelProps>((props, ref) => {
  const {
    sectors,
    onSpinStart,
    onSpinEnd,
